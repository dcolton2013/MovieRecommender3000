...
public class DBFinal {
  ...
  private static Scanner scan = new Scanner(System.in);
    ...
    public static void main(String[] args)throws SQLException, IOException, ClassNotFoundException {
        ...
        System.out.println("Scehma: movieRecommender3000");
    ...
    public static class MovieRecommender{
        ...
        private void createDB() throws SQLException, IOException {
            ...
            try {
                stmt.executeUpdate("create schema if not exists movieRecommender3000;");
        ...
        private void populateDB(String fileName, String table) {
            //data files must be saved in datasets folder
            String populate = "LOAD DATA LOCAL INFILE 'datasets/" + fileName + "' INTO TABLE " + table + ";";
